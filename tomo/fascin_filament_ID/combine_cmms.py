...
if __name__ == "__main__":
    ...
    base_path = '/rugpfs/fs0/cem/store/mreynolds/fascin_tomos/subtomo_averaging/alpha_values_bin1/bilds/automated_fil_identification_stable_cores/'
    base_path = base_path + 'ts058_C/'
    filenames = [base_path+'set_063.cmm', base_path+'set_068.cmm', base_path+'set_037_set_051.cmm']  # Add your filenames here
